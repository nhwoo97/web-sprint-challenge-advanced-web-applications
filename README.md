...
1. Explain what a token is used for.
   Token is an identifier to allow the website to see that the user has authorized access to the specific material
2. What steps can you take in your web apps to keep your data secure?
   You can add protected routes
3. Describe how web servers work.
   A webserver is a computer that is linked to the web. It hosts the website allowing us to access the website that it hosts
